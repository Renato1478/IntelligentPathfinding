...
class MazeViewer():
    ...
    def __init__(self, labirinto, start, goal, titulo_janela, zoom=20, step_time_miliseconds=-1):
        self._labirinto = labirinto
        self._zoom = zoom
        self._step = step_time_miliseconds
        self._start = start
        self._goal = goal
        self._titulo_janela = titulo_janela
    ...
    def update(self, generated=[], expanded=[], path=[]):
        ...
        cv2.imshow(self._titulo_janela, maze_img)
